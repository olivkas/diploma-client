...
import { addJumper } from '../../actions/jumpers';
import moment from 'moment';
import DatePicker from 'react-datepicker';

import { set } from 'mongoose';

const JumperForm = ({ addJumper, stateModal }) => {
      ...
      <div className='modalOverlay'>
        <div className='modalWindow'>
          <div className='modalHeader'>
            <div className='modalTitle'>Новая перемычка</div>
            <i
...
JumperForm.propTypes = {
  addJumper: PropTypes.func.isRequired,
};

export default connect(null, { addJumper })(JumperForm);
